...
% Element class for a 3-dimensional framed structure
    ...
    methods (Access = public)
        ...
        function self = ADSA_Element(element_nodes,A,Izz,Iyy,J,Cw,Zzz,Zyy,...
		Ayy,Azz,E,v,Fy,YldSurf,Wt,webdir,w)
    ...
    methods (Access = private)
        ...
        function [FixedEndForcesLocal, FixedEndForcesGlobal]=ComputeFixedEndForces(self)
            ...
            %equations.
            FixedEndForcesLocal=[-self.DistribLoad(1)*self.length/2;%MUST ADD w to PROPERTIES!
